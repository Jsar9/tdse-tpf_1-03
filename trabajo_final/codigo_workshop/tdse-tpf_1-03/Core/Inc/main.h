...
#define LED_CL_GPIO_Port GPIOB
#define ESC_BTN_Pin GPIO_PIN_13
#define ESC_BTN_GPIO_Port GPIOB
#define ENT_BTN_Pin GPIO_PIN_14
#define ENT_BTN_GPIO_Port GPIOB
#define NEXT_BTN_Pin GPIO_PIN_15
